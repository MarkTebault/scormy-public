...
function doExit() {
    ...
    // no way to determine if the user actually completed the document, so assume
    // the user is complete if they opened the document.
...
// this is called every second to ensure the progress is captured 
