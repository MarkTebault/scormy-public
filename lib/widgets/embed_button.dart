...
class EmbedButton extends StatelessWidget {
  final Future futureMethod;
  const EmbedButton({super.key, required this.futureMethod});
            ...
            default:
              if (snapshot.hasError) {
                ...
                return ElevatedButton.icon(
                    ...
                    label: Text(AppLocalizations.of(context)!.embedcodeCourse,
                        style: const TextStyle(fontSize: 18)),
                    onPressed: () => context.go('/embed'));
              } else {
